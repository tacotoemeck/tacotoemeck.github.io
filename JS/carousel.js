...
const sliderContent = [
    ...
    },
    {
        ...
        projectName: "iVe Full Stack Node JS app",
    ...
    },
    {
        ...
        projectName: "Simple JavaScript jornal entry app",
    ...
    },
    {
        ...
        projectName: "Drum Machine JavaScript",
        viewLink: "https://codepen.io/tacotomek/pen/gOOewrZ",
    ...
    },
    {
        ...
        projectName: "Pomodor Time JavaScript App",
...
function appendImagesIntoAList(i, insertLocation) {
    ...
    li.innerHTML = `
    <img src=${sliderContent[i].displayImage} class="sliderImages" alt="{${sliderContent[i].projectName}}">
